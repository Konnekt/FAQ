...
<div id="content">
  ...
  <h2>emNotifier</h2>
  <h5>Obsługa kont pocztowych z komunikatora</h5>
  ...
  <p>Wtyczka sprawdzająca konta pocztowe POP3 w określonych odstępach czasu i informująca o nowej poczcie przy pomocy tworzonego przez wtyczkę okna. Może sprawdzać dowolną liczbę kont. Posiada możliwość zmiany wyglądu okna opartego na XML-u. Do poprawnej obsługi konta na GMail.com wymagana jest wersja z obsługą SSL - minimalnie wersja 1.0.0.7b z centralki kPlugins.</p>
  ...
  <img src="pic/plug_emnotifier/screen_a.png" alt="" class="left" />
  <p>Przejdźmy do konfiguracji wtyczki. Aby to zrobić kliknij w menu <span class="tool">Ustawienia</span> wybierz pozycję <span class="menu">Ustawienia</span>. W nowym oknie z listy po lewej rozwiń <span class="list">Wtyczki</span> i wybierz <span class="list">emNotifier</span>.</p>

  <h3 id="konta">Konta</h3>
  <img src="pic/plug_emnotifier/screen_b.png" alt="" class="right" />
  ...
  <img src="pic/plug_emnotifier/screen_c.png" alt="" class="right" />
  <p>Efekt końcowy wygląda następująco.</p>
